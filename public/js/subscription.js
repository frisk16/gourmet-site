...
cardButton.addEventListener('click', async(e) => {
    ...
    if(error) {
        ...
        const storeSubscribeForm = document.forms.store_subscribe_form;

        document.querySelector('.back-ground').style.display = 'block';
        document.querySelector('.loading').style.display = 'block';
        storeSubscribeForm.paymentMethodId.value = setupIntent.payment_method;
        storeSubscribeForm.submit();
    }
});
